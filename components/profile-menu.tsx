        ...
        <DropdownMenuTrigger asChild>
            <div className="flex items-center space-x-2 cursor-pointer">
                <div className="relative aspect-square h-8 w-8">
                    <Image className="rounded-full hover:scale-105 transition object-cover object-center ring-1 ring-offset-1 ring-black" src={profileData.image ? profileData.image : ''} alt="" fill sizes="icon" priority />
                </div>
